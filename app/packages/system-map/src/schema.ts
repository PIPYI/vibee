...
// `../schemas/...` / `../examples/...`.
const SCHEMA_URL = new URL("../schemas/system-map.schema.json", import.meta.url);
const EXAMPLE_URL = new URL("../examples/minimal.system-map.json", import.meta.url);
